...
\begin{figure}[H] % ← Table.1の直後に出す
\centering
\scriptsize
\resizebox{\columnwidth}{!}{%
\begin{tikzpicture}[node distance=12mm] % ノード間隔を広めに
  % ノード
...
% === Fig.2: AITL architecture (uncluttered, Tri-NVM at bottom) ===
\begin{figure}[H]
\centering
\scriptsize
\resizebox{\columnwidth}{!}{%
\begin{tikzpicture}[node distance=9mm]
  ...
  % FSM Supervisor
  \node[smallbox, right=18mm of rc1, align=center] (fs1) {モード管理\\\small Safe/Nominal/Recovery};
  ...
  % AI Adaptor
  \node[smallbox, right=18mm of fs1, align=center] (ai1) {長期リID/ドリフト補償};
  ...
  % Tri-NVM (下段横並びで重なり解消)
  \node[smallbox, below=14mm of rc3, align=center] (sram) {SRAM\\\small 実行/ECC};
  \node[smallbox, right=14mm of sram, align=center] (mram) {MRAM\\\small ログ/コード/ECC};
  \node[smallbox, right=14mm of mram, align=center] (fram) {FRAM\\\small セーフブート/FSM};
