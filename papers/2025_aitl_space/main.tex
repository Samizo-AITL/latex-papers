...
% === Fig.2 (DROP-IN REPLACEMENT) ==========================
\begin{figure}[t]
\centering
% 2カラムでも読みやすいよう少し大きめ
\resizebox{0.88\textwidth}{!}{%
\begin{tikzpicture}[
  node distance = 8mm and 18mm,         % 縦,横の基本間隔（横を広め）
  >=Latex,
  ...
  mem/.style    = {box, minimum width=34mm}, % メモリは少し広め
...
% ===== 交差＆重なりゼロのための「入口座標」を用意（矢印は手前で止める） =====
...
\end{tikzpicture}}%
\caption{AITL architecture (simplified): three-layer control stack with role-partitioned tri-NVM hierarchy.}
\label{fig:arch}
\end{figure}
% ==========================================================
