...
\begin{semilogxaxis}[
  ...
  axis lines=left,
  grid=both, grid style={gray!25}, minor grid style={gray!15},
  tick pos=left, tick align=inside, tick style={black},
  ytick distance=10,
  legend columns=2,
  ...
  % モノクロの線種サイクル
  cycle list={
    {black, solid, line width=0.9pt},
    {black, dashed, line width=0.9pt},
    {black, densely dotted, line width=0.9pt},
    {black, dotted, line width=0.9pt}
  },
  every axis plot/.append style={mark=none, smooth}
]

% |S(jw)| (target)
\addplot coordinates{
  (0.1,-20) (0.2,-20) (0.5,-20) (0.8,-20) (1,-20) (1.5,-19) (2,-18)
  (3,-17) (5,-15) (7,-13) (10,-10) (15,-13) (20,-15) (30,-18)
  (50,-25) (70,-32) (100,-40) (150,-46) (200,-50) (300,-53)
  (500,-55) (700,-57) (1000,-60)
};
\addlegendentry{$|S(j\omega)|$ (target)}

% |T(jw)| (target)
\addplot coordinates{
  (0.1,0) (0.2,0) (0.5,0) (0.8,0) (1,0) (2,0) (5,0) (7,0) (10,0)
  (15,-2) (20,-5) (30,-7) (50,-10) (70,-14) (100,-20) (150,-26)
  (200,-30) (300,-33) (500,-35) (700,-38) (1000,-40)
};
\addlegendentry{$|T(j\omega)|$ (target)}

% 1/|W1| (disturbance rejection)
\addplot coordinates{
  (0.1,-40) (0.2,-36) (0.5,-30) (0.8,-24) (1,-20) (1.5,-15) (2,-10)
  (3,-6) (5,-2) (7,0) (10,0) (15,0) (20,0) (30,0) (50,0) (70,0)
...
% 1/|W3| (roll-off)
\addplot coordinates{
  (0.1,0) (0.2,0) (0.5,0) (0.8,0) (1,0) (1.5,-2) (2,-3) (3,-6) (5,-10)
  (7,-14) (10,-20) (15,-23) (20,-25) (30,-30) (50,-35) (70,-38)
  (100,-40) (150,-46) (200,-50) (300,-53) (500,-55) (700,-58) (1000,-60)
};
\addlegendentry{$1/|W_3|$ (roll-off)}

\end{semilogxaxis}
\end{tikzpicture}
\caption{Frequency-domain intuition for \texorpdfstring{$H_\infty$}{H-infty} design:
low $|S|$ at low--mid frequency and low $|T|$ at high frequency.}
\label{fig:weights}
\end{figure}
