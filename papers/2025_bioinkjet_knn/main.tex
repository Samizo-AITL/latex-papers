...
\input{sections/simulation}   % Droplet Formation Simulation
\input{sections/comparison}   % Material Performance Comparison
\input{sections/mapping}      % Bio-Application Suitability Map
...
% ===== References =====
\nocite{Saito2004KNN,Dubois2019BioIJ,Takenaka2017BNT,Zhang2019ScAlN,Murphy2020Bioprinting}
...
architecture, and AI system integration.
\end{document}
