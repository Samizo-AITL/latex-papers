...
% ===== Body =====
% 章タイトルは各 sections/*.tex の先頭の \section に任せる
...
% ===== Results / Extended Analysis (本文として結論の前に配置) =====
\input{sections/simulation}   % Droplet Formation Simulation（図：figs/droplet_volume_vs_voltage.png 等）
\input{sections/comparison}   % Material Performance Comparison（表）
\input{sections/mapping}      % Bio-Application Suitability Map（図：ヒートマップ）
