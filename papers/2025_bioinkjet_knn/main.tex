...
% ===== Graphics handling =====
\graphicspath{{figures/}{images/}{./}} % search paths for figures
\DeclareGraphicsExtensions{.pdf,.png,.jpg,.jpeg} % valid extensions
...
\input{sections/proposal}   % <-- Figures handled inside with IfFileExists
\input{sections/applications}
\input{sections/conclusion}

% ------ Ensure references appear even if not cited explicitly ------
