...
% ============================================================
\begin{abstract}
本論文は，設計，信頼性，および制御を統一的に扱う新しい工学アーキテクチャ
...
最終的には，SystemDK with AITL Coreを
自律的設計システム（Autonomous Design System）の基盤として確立することを目指す。
...
By dynamically coupling physical and logical models,
...
a foundational architecture for autonomous and self-consistent engineering systems.
\end{abstract}

\begin{IEEEkeywords}
System Design, Reliability, Control Integration, PID, FSM, LLM, Autonomous Architecture, Integrated Framework, Self-consistent Engineering
\end{IEEEkeywords}
