...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    ...
    下電極 & Pt & 80 nm / (111) 配向，PZT配向誘導膜 \\
    seed層 & Ir & 10 nm / Pt層の結晶成長安定化 \\
    Ti緩衝層 & Ti & 4 nm / 初期焼成後に挿入，応力緩和・界面制御 \\
    PZT層 & Pb(Zr,Ti)O\textsubscript{3} & 1200 nm / 200 nm × 6層，$d_{33}$駆動に最適化 \\
    上電極 & Ir/Ti & 10/10 nm / 応力緩和・反応抑制，多層構成 \\
    \hline
  \end{tabular}
\end{table}
