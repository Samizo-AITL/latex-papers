...
\begin{figure}[htbp]
  ...
  % Preamble requires: \usepackage{tikz}
  \tikzset{
  ...
  \begin{tikzpicture}[x=1mm,y=1mm]
    ...
    \begin{scope}
      ...
      % Legend box
      \draw (2,3) node[lbl,anchor=west] {$\square$ Au/NiCr} ;
      \draw (18,3) node[lbl,anchor=west] {$\blacksquare$ PZT (schematic)} ;
    \end{scope}
    ...
    \begin{scope}[xshift=\W+12mm]
      ...
      \node[lbl] at (20,15.5) {Au/NiCr};
      \node[lbl] at (50,15.5) {Au/NiCr};
      % Longer effective path with slit in substrate
      \draw[slit] (34,0) rectangle (36,18);  % Vertical slit cutting up from substrate
