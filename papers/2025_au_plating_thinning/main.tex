...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[x=0.9mm,y=0.9mm,>=Latex,inner sep=1pt]
    \path[use as bounding box] (0,0) rectangle (80,105);

    %==== 対策前 ====
    \node[font=\small] at (40,53) {対策前：TE 表面で Au マイグレーション発生リスク};

    % 下地層
    \fill[gray!30] (8, 8) rectangle (70,14);   % BE
    \fill[gray!15] (8,14) rectangle (70,26);   % PZT
    \fill[gray!10] (8,26) rectangle (70,28);   % TE
    \node[font=\scriptsize,anchor=west] at (72,10.0) {BE 100 nm};
    \node[font=\scriptsize,anchor=west] at (72,20.0) {PZT 1.2 µm};
    \node[font=\scriptsize,anchor=west] at (72,27.8) {TE 20 nm};
    ...
    % COF端子
    \fill[orange!35] (20,41) rectangle (32,43.7);
    \fill[brown!30]  (20,43.7) rectangle (32,49.7);
    ...
    %==== 対策後 ====
    \node[font=\small] at (40,100) {対策後：沿面改質・電界緩和によるマイグレーション抑制};

    % 下地層（PZT抜き）
    \fill[gray!30] (8,62) rectangle (70,68);   % BE
    \fill[gray!15] (8,68) rectangle (70,80);   % PZT
    \fill[white] (38,68) rectangle (40,80);    % スリット抜き
    \fill[gray!10] (8,80) rectangle (70,82);   % TE
    \node[font=\scriptsize,anchor=west] at (72,64.0) {BE 100 nm};
    \node[font=\scriptsize,anchor=west] at (72,74.0) {PZT 1.2 µm};
    \node[font=\scriptsize,anchor=west] at (72,81.8) {TE 20 nm};
