...
% =====================================================
% Appendix: Countermeasure Figure (縦並び版・PZTスリット削除)
% =====================================================
\begin{figure}[!t]
  \centering
  \resizebox{\columnwidth}{!}{%
  \begin{tikzpicture}[x=1mm,y=1mm,>=Latex,inner sep=1pt]
    % 図全体の外形を固定（はみ出し防止）
    \path[use as bounding box] (0,0) rectangle (80,95);
  ...
  下：対策後は沿面電界緩和・界面改質によってマイグレーション抑制効果を示す。
  下地：NiCr 50 nm／TE 20 nm／PZT 1.2 µm／BE 100 nm。}
  \label{fig:act-mig-clean-noslit}
\end{figure}
