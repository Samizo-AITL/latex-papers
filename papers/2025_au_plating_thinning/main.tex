...
% =====================================================
% Appendix: Auマイグレーション対策図（1カラム対応版）
% =====================================================
\begin{figure}[t]
  \centering
  % 横幅をcolumnwidthに調整（オーバーラップ防止）
  \resizebox{0.95\columnwidth}{!}{%
  \begin{tikzpicture}[x=1mm,y=1mm,>=Latex,inner sep=1pt]
    % --- 図全体外形 ---
    \path[use as bounding box] (0,0) rectangle (70,90);
    ...
    \begin{scope}
      ...
      % タイトル
      \node[font=\small] at (31,46.0) {対策前：TE表面でAuマイグレーション発生リスク};
    \end{scope}
    ...
    \begin{scope}[yshift=-55mm]
      ...
      % タイトル
      \node[font=\small] at (31,46.0) {対策後：沿面改質・電界緩和によるマイグレーション抑制};
    \end{scope}
