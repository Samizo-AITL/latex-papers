...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[x=0.90mm, y=0.90mm, >=Latex, inner sep=1pt]
    \def\BEth{6.0} \def\PZTth{12.0} \def\TEth{2.0}
    \def\Actth{13.0} \def\COFAuth{2.7} \def\COFCuth{6.0}
    \def\TitleGap{3.0}
    \def\Xl{8} \def\Xr{70}
    \def\ActL{20} \def\ActR{32} \def\ActLtwo{46} \def\ActRtwo{58}
    \def\RightLabelX{74}
    \def\GapL{34} \def\GapR{44}
    \def\yTitleT{100.0} \def\yTitleB{52.0}

    %==== 上：対策前 ====
    \node[font=\small, anchor=south] at ({0.5*(\Xl+\Xr)}, \yTitleT)
    ...
    \fill[gray!30] (\Xl,\yBEBotT) rectangle (\Xr,{\yBEBotT+\BEth});
    \fill[gray!15] (\Xl,{\yBEBotT+\BEth}) rectangle (\Xr,{\yPZTBotT+\PZTth});
    \fill[gray!10] (\Xl,{\yTEBotT}) rectangle (\Xr,{\yTEBotT+\TEth});
    ...
    %==== 下：対策後 ====
    \node[font=\small, anchor=south] at ({0.5*(\Xl+\Xr)}, \yTitleB)
    ...
    \fill[gray!15] (\Xl,{\yBEBotB+\BEth}) rectangle (\GapL,{\yPZTBotB+\PZTth});
    \fill[gray!15] (\GapR,{\yBEBotB+\BEth}) rectangle (\Xr,{\yPZTBotB+\PZTth});
    \fill[gray!10] (\Xl,\yTEBotB) rectangle (\GapL,{\yTEBotB+\TEth});
    \fill[gray!10] (\GapR,\yTEBotB) rectangle (\Xr,{\yTEBotB+\TEth});
