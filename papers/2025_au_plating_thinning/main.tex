...
% ===== Appendix: Countermeasure Figure (single-column) =====
\begin{figure}[t]
  \centering
  \resizebox{\columnwidth}{!}{%
  \begin{tikzpicture}[x=1mm,y=1mm,>=Latex]
    % ---- Common layer stack (baseline) ----
    % Left panel (Before)
    \begin{scope}
      % BE
      \fill[gray!30] (0,0) rectangle (62,6);
      \node[font=\scriptsize] at (31,1.7) {BE (100 nm)};
      % PZT
      \fill[gray!15] (0,6) rectangle (62,18);
      \node[font=\scriptsize] at (31,9.5) {PZT (1.2 µm)};
      % TE
      \fill[gray!10] (0,18) rectangle (62,20);
      \node[font=\scriptsize] at (31,19.1) {TE (20 nm)};
      % Actuator Au electrodes (1.3 µm)
      \fill[gray!60] (12,20) rectangle (24,33);
      \fill[gray!60] (38,20) rectangle (50,33);
      \node[font=\scriptsize] at (18,31.5) {Au 1.3 µm (Act)};
      \node[font=\scriptsize] at (44,31.5) {Au 1.3 µm (Act)};
      % NiCr sidewall (optional lining)
      \fill[gray!50] (50,20) rectangle (51,33);
      \node[font=\scriptsize,anchor=west] at (51.5,27) {NiCr 50 nm};
      % COF pads on top (Au/Cu)
      \fill[orange!35] (12,33) rectangle (24,35.7);  % COF Au 0.425
      \fill[brown!30]  (12,35.7) rectangle (24,41.7); % COF Cu 8
      \fill[orange!35] (38,33) rectangle (50,35.7);
      \fill[brown!30]  (38,35.7) rectangle (50,41.7);
      \node[font=\scriptsize] at (18,34.7) {COF Au 0.425 µm};
      \node[font=\scriptsize] at (18,40.7) {Cu 8 µm};
      \node[font=\scriptsize] at (44,34.7) {COF Au 0.425 µm};
      \node[font=\scriptsize] at (44,40.7) {Cu 8 µm};
      % Au migration arrow on TE
      \draw[->] (26,19.8) -- (36,19.8);
      \node[font=\scriptsize] at (31,21.0) {Au migration on TE};
      % Title
      \node[font=\small] at (31,45) {対策前（Auマイグレーション発生リスク）};
    \end{scope}

    % ---- Vertical separator ----
    \draw[dashed] (66,0) -- (66,46);

    % ---- Right panel (After: PZT slit) ----
    \begin{scope}[xshift=72mm]
      % BE
      \fill[gray!30] (0,0) rectangle (62,6);
      \node[font=\scriptsize] at (31,1.7) {BE (100 nm)};
      % PZT with slit
      \fill[gray!15] (0,6) rectangle (27,18);
      \fill[gray!15] (35,6) rectangle (62,18);
      \draw[line width=0.4pt] (31,6) -- (31,0); % slit trench
      \node[font=\scriptsize] at (31,9.5) {PZT (1.2 µm)};
      \node[font=\scriptsize,rotate=90] at (33.3,9.0) {PZT スリット};
      % TE
      \fill[gray!10] (0,18) rectangle (27,20);
      \fill[gray!10] (35,18) rectangle (62,20);
      \node[font=\scriptsize] at (31,19.1) {TE (20 nm)};
      % Actuator Au electrodes (1.3 µm)
      \fill[gray!60] (12,20) rectangle (24,33);
      \fill[gray!60] (38,20) rectangle (50,33);
      ...
      \node[font=\scriptsize] at (44,31.5) {Au 1.3 µm (Act)};
      % COF pads on top (Au/Cu)
      \fill[orange!35] (12,33) rectangle (24,35.7);
      \fill[brown!30]  (12,35.7) rectangle (24,41.7);
      \fill[orange!35] (38,33) rectangle (50,35.7);
      \fill[brown!30]  (38,35.7) rectangle (50,41.7);
      \node[font=\scriptsize] at (18,34.7) {COF Au 0.425 µm};
      \node[font=\scriptsize] at (18,40.7) {Cu 8 µm};
      ...
      \node[font=\scriptsize] at (44,40.7) {Cu 8 µm};
      % Title
      \node[font=\small] at (31,45) {対策（PZTスリット導入：実効沿面距離の延長）};
    \end{scope}
  \end{tikzpicture}%
  }
  \vspace{2mm}
  \caption{COF端子（Au 0.425 µm／Cu 8 µm）をアクチュエータAu電極（1.3 µm）の上に重ねて実装した断面模式図。左：対策前はTE表面でAuマイグレーションが起点となり得る。右：PZTスリット導入により端子間の実効沿面距離を延長し、マイグレーションを抑制。下地：NiCr 50 nm／TE 20 nm／PZT 1.2 µm／BE 100 nm。}
  \label{fig:act-mig-clean}
\end{figure}
