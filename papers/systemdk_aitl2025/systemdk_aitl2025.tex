...
\usepackage{flushend}   % 最終ページ左右カラム揃え
\usepackage{placeins}   % \FloatBarrier 用
...
Proof-of-concept co-simulations (FEM + RTL testbench) demonstrate over
$100\times$ reduction in delay deviation,
thermal overshoot below $3\times 10^{-5}\%$, and EMI-induced jitter
...
% --- References + Biography on page 2 right column ---
\vfill
\begin{thebibliography}{1}
\bibitem{yakimets2020} N.~Amal, A.~Vandooren, S.~Yakimets, \textit{et al.}, ``CFET integration: opportunities and challenges,'' in \emph{Proc. IEEE IEDM}, 2020, pp. 1--4.
\bibitem{irds2023} IRDS, ``International Roadmap for Devices and Systems (IRDS),'' IRDS 2023 Edition, 2023. [Online]. Available: \url{https://irds.ieee.org}
\bibitem{franklin2015} G.~F. Franklin, J.~D. Powell, and A.~Emami-Naeini, \emph{Feedback Control of Dynamic Systems}, 7th ed. Pearson, 2015.
\bibitem{khalil2002} H.~K. Khalil, \emph{Nonlinear Systems}, 3rd ed. Prentice Hall, 2002.
\bibitem{anderson2007} B.~D.~O. Anderson and J.~B. Moore, \emph{Optimal Control: Linear Quadratic Methods}. Dover, 2007.
\bibitem{iec2019} IEC 61000-4, ``Electromagnetic compatibility (EMC): Testing and measurement techniques,'' 2019.
\end{thebibliography}
