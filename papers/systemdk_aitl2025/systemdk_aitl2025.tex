...
\usepgfplotslibrary{colormaps,patchplots} % ← 追加：colormap/surf系のキーを有効化

\usepackage{microtype}
\usepackage[hidelinks]{hyperref}

% ---------- Plot styles ----------
% 無名 cycle list だと /tikz/... キー誤解釈が出る環境があるため、名前付きに変更
...
\pgfplotsset{
  every axis/.append style={
    ...
    cycle list name=aitlCycle, % ← 追加：上で定義したリストを常用
  },
}
