...
% ====== Related/Analysis/Limitations/Outlook ======
...
% ===== References（2ページ右欄に来るよう本文中に直書き）=====
\begin{thebibliography}{6}\footnotesize
\bibitem{yakimets2020cfet}
...
\emph{Feedback Control of Dynamic Systems}, 7th~ed. Pearson, 2015.
...
\emph{Optimal Control: Linear Quadratic Methods}. Dover, 2007.

\bibitem{iec61000}
IEC, ``Electromagnetic Compatibility (EMC)—Part 4: Testing and Measurement Techniques,''
IEC Std. IEC~61000-4, 2019.
\end{thebibliography}

% ===== Author Biography（引用の直後に続ける）=====
  ...
  \subfloat[Delay vs.\ time (No control / PID / PID+FSM+LLM).]{
    \begin{tikzpicture}
      \begin{axis}[
        ...
        legend style={at={(0.5,-0.18)},anchor=north,draw=none,fill=none}
      ]
        % No control
