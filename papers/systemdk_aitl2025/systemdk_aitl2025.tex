...
\begin{figure*}[!t]
  ...
  % (a) Heatmap
  \subfloat[Suppression vs.\ $k_c$ and $P_{\text{burst}}$ (FEM co-sim).]{
    \begin{tikzpicture}
      \begin{axis}[
        width=0.38\textwidth, height=0.28\textwidth,
        xlabel={$k_c$}, ylabel={$P_{\text{burst}}$ (W)},
        colormap/viridis, colorbar,
        point meta min=0, point meta max=100
      ]
        \addplot3[surf, shader=interp, samples=30, samples y=25,
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+[thick] table[row sep=\\]{x y\\
          0 1.0\\ 0.1 0.90\\ 0.2 0.80\\ 0.3 0.85\\ 0.4 0.75\\
          0.5 0.80\\ 0.6 0.70\\ 0.7 0.78\\ 0.8 0.72\\ 0.9 0.76\\ 1.0 0.74\\};
        ...
        \addlegendentry{PID}
        \addplot+[thick] table[row sep=\\]{x y\\
          0 0.25\\ 0.1 0.12\\ 0.2 0.07\\ 0.3 0.05\\ 0.4 0.03\\
          0.5 0.025\\ 0.6 0.020\\ 0.7 0.018\\ 0.8 0.016\\ 0.9 0.015\\ 1.0 0.014\\};
  ...
  \subfloat[EMI-induced jitter suppression (normalized RMS).]{
    \begin{tikzpicture}
      \begin{axis}[
        ...
        xtick=data, ymin=0, ymax=1.1,
        ylabel={Norm. RMS jitter},
