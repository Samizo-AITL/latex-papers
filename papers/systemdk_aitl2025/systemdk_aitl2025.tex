...
% ===== Table 1 : keep on page 2 with Fig.1 =====
\begin{table}[t]
\centering
...
% ===== Related Work with explicit citations =====
...
Control theory provides analytical foundation\cite{anderson2007,khalil2002}.
EMI compliance follows IEC standards\cite{iec2019}.
Commercial tools (e.g., Synopsys PrimeTime, Cadence Tempus) focus on static sign-off,
motivating runtime-aware extensions\cite{franklin2015}.
...
% ===== ここで全フロートを流し切って Fig.2 を次ページに =====
\clearpage

% ===== Fig.2 : 大きく・縦並び。(b)の凡例は上外側に配置済み =====
\begin{figure*}[!t]
  \centering
...
N.~Arnal, A.~Vandooren, S.~Yakimets, \emph{et al.}, ``CFET integration: opportunities and challenges,'' in \emph{Proc. IEEE IEDM}, 2020, pp.~1--4.

\bibitem{irds2023}
IEEE Industry Roadmap for Devices and Systems (IRDS), ``IRDS 2023 Edition,'' 2023. [Online]. Available: \url{https://irds.ieee.org}

\bibitem{franklin2015}
D.~Franklin and M.~Horowitz, ``The art of signoff: closing timing, power, and variability,'' \emph{IEEE Micro}, vol.~35, no.~6, pp.~10--21, 2015.
...
\bibitem{iec2019}
IEC 61000-4, ``Electromagnetic compatibility (EMC),'' International Electrotechnical Commission, 2019.
