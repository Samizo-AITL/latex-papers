...
\usepackage[section]{placeins} % ← セクションをまたいだ回り込みを防ぐ
...
% ===== Fig.2 : 大きさ統一＆横幅抑制、凡例の被り解消、参考文献への食い込み防止 =====
\begin{figure*}[t!]
  \centering
  % 共通サイズ
  \def\w{0.70\textwidth}
  ...
  \subfloat[Delay vs.\ time (No control / PID / PID+FSM+LLM).]{
    \begin{tikzpicture}
      \begin{axis}[
        ...
        legend style={
          at={(1.02,0.98)}, anchor=north west, draw=none,
...
\FloatBarrier % ← ここでFig.2までを確実に吐き出してから次セクションへ
