...
\begin{figure}[!t]
  ...
  \subfloat[Suppression vs.\ $k_c$ and $P_{\text{burst}}$ (FEM co-sim, synthetic).]{
    \begin{tikzpicture}
      \begin{axis}[
        width=0.94\linewidth, height=0.38\linewidth,
        xlabel={$k_c$}, ylabel={$P_{\text{burst}}$ (W)},
        colormap/viridis, colorbar,
        point meta min=0, point meta max=100
      ]
        \addplot3[
          surf, shader=interp, samples=30, domain=0:1, y domain=0.1:1.0
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+[thick, mark=none] coordinates
          {(0,1.0)(0.1,0.9)(0.2,0.8)(0.3,0.85)(0.4,0.75)(0.5,0.8)(0.6,0.7)(0.7,0.78)(0.8,0.72)(0.9,0.76)(1.0,0.74)};
        \addlegendentry{No control}

        \addplot+[thick, mark=none] coordinates
          {(0,0.6)(0.1,0.45)(0.2,0.35)(0.3,0.28)(0.4,0.24)(0.5,0.22)(0.6,0.20)(0.7,0.19)(0.8,0.18)(0.9,0.18)(1.0,0.17)};
        \addlegendentry{PID}

        \addplot+[thick, mark=none] coordinates
          {(0,0.25)(0.1,0.12)(0.2,0.07)(0.3,0.05)(0.4,0.03)(0.5,0.025)(0.6,0.020)(0.7,0.018)(0.8,0.016)(0.9,0.015)(1.0,0.014)};
