...
\begin{tikzpicture}
  \begin{axis}[
    ...
    xlabel={VDD [V]},
    ylabel={Fail Bit Count (capped at 100)},
    ymin=0, ymax=100,
    xmin=2.6, xmax=3.6,
    xtick={2.6,2.8,3.0,3.2,3.4,3.6},
  ...
  \addplot[mark=o,blue,thick] coordinates {
    (2.6,100) (2.8,100) (3.0,95) (3.2,100) (3.4,100) (3.6,100)
  };
  \addlegendentry{25℃}
  % Untreated at 85℃
...
\begin{tikzpicture}
  ...
  \addplot[mark=triangle*,blue,thick] coordinates {
    (2.6,40) (2.8,30) (3.0,20) (3.2,10) (3.4,5) (3.6,0)
  };
  \addlegendentry{25℃}
  % 85℃
  \addplot[mark=square*,red,thick,dashed] coordinates {
    (2.6,100) (2.8,90) (3.0,70) (3.2,40) (3.4,10) (3.6,0)
  };
  \addlegendentry{85℃}
  \end{axis}
\end{tikzpicture}
...
\caption{Shmoo plots of fail bit counts vs VDD at 25℃ and 85℃ under different process conditions. Counts are capped at 100.}
