...
\begin{tikzpicture}[x=1cm,y=1cm]
  % Active
  \fill[gray!20] (0,0) rectangle (6,0.7);
  \node[anchor=west] at (0.1,0.08) {\scriptsize Active};

  % Poly
  \fill[blue!22] (2,0.7) rectangle (3,2.1);
  \node at (2.5,1.6) {\scriptsize Poly};

  % Side Wall
  \fill[gray!55] (3,0.7) -- (3.25,0.7) -- (3.05,2.1) -- (3,2.1) -- cycle;
  \node[anchor=west] at (3.05,1.55) {\scriptsize Side Wall};

  % TiSi2（Poly上）
  \fill[red!28] (2,2.1) rectangle (3,2.35);
  \node[red!60!black] at (2.5,2.48) {\scriptsize TiSi$_2$};

  % TiSi2（拡散側）
  \fill[red!28] (3.25,0.7) rectangle (5.8,0.9);
  \node[red!60!black,anchor=west] at (4.7,1.02) {\scriptsize TiSi$_2$};

  % Halo B
  \fill[orange!45,opacity=.45] (3.15,0.42) ellipse (0.45 and 0.18);
  \draw[orange!70!black,->] (3.15,0.75) -- (3.15,0.55);
  \node[orange!70!black,anchor=west] at (3.25,0.78) {\scriptsize Halo B};
  \node[orange!70!black,anchor=west] at (3.25,0.58) {\scriptsize C49残留};
\end{tikzpicture}
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  % Poly（リセス）
  \fill[blue!22] (2.1,0.7) -- (2.0,2.1) -- (3.0,2.1) -- (2.9,0.7) -- cycle;
  \node at (2.45,1.6) {\scriptsize Poly};

  % Side Wall
  \fill[gray!55] (2.9,0.7) -- (3.35,0.7) -- (3.10,2.1) -- (3.0,2.1) -- cycle;
  \node[anchor=west] at (3.05,1.55) {\scriptsize Side Wall};

  % TiSi2（Poly上）
  \fill[red!28] (2.1,2.1) rectangle (3.0,2.35);
  \node[red!60!black] at (2.55,2.48) {\scriptsize TiSi$_2$ (C54)};

  % TiSi2（拡散側）
  \fill[red!28] (3.38,0.7) rectangle (5.8,0.9);
  \node[red!60!black,anchor=west] at (4.7,1.02) {\scriptsize TiSi$_2$};

  % Halo B（離隔強調）
  \fill[orange!45,opacity=.35] (3.15,0.38) ellipse (0.45 and 0.18);
  \draw[orange!70!black,->] (3.55,0.9) -- (3.35,0.55);
  \node[orange!70!black,anchor=west] at (3.6,0.92) {\scriptsize Halo B};
  \node[orange!70!black,anchor=west] at (3.6,0.72) {\scriptsize C54安定化};
\end{tikzpicture}

\footnotesize (b) 対策後（Side Wall Etch Under）

\caption{サイドウォール・エッチアンダーの効果模式図。対策前は Halo B が TiSi$_2$ 前線に近接して C49 残留を助長。(b) 対策後は距離が確保され、C54 相への転移が安定化し局所高抵抗スポットが抑制された。}
