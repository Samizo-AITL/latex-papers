...
\begin{tikzpicture}
  ...
  % 25°C：3.0Vまではほぼ0、未満で急増
  \addplot[mark=o,blue,thick] coordinates
    {(2.6,95) (2.8,65) (3.0,2) (3.2,0) (3.4,0) (3.6,0)};
  \addlegendentry{25\,°C}
  % 85°C：25°Cより悪化、3.0Vでも少し出る
  \addplot[mark=square*,red,thick,dashed] coordinates
    {(2.6,100) (2.8,85) (3.0,15) (3.2,5) (3.4,2) (3.6,0)};
  \addlegendentry{85\,°C}
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \addplot[mark=triangle*,blue,thick] coordinates
    {(2.6,70) (2.8,40) (3.0,10) (3.2,4) (3.4,0) (3.6,0)};
  \addlegendentry{25\,°C}
  % 85°C：高温で不良だがVDD↑で回復
  \addplot[mark=square*,red,thick,dashed] coordinates
    {(2.6,100) (2.8,85) (3.0,50) (3.2,25) (3.4,5) (3.6,0)};
  \addlegendentry{85\,°C}
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  % 25°C：2.6Vのみ少数、以降0
  \addplot[mark=o,blue,thick] coordinates
    {(2.6,8) (2.8,0) (3.0,0) (3.2,0) (3.4,0) (3.6,0)};
  \addlegendentry{25\,°C}
  % 85°C：2.6Vでやや悪化、以降0
  \addplot[mark=square*,red,thick,dashed] coordinates
    {(2.6,12) (2.8,0) (3.0,0) (3.2,0) (3.4,0) (3.6,0)};
  \addlegendentry{85\,°C}
  \end{axis}
\end{tikzpicture}
