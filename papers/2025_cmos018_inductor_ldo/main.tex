...
\begin{figure}[t]
  \centering
  \includegraphics[width=.75\linewidth]{fig/fig1_laminated_cross_section.png}
...
(Senior Member, IEEE) received the B.S., M.S., and Ph.D. degrees in electronic engineering. 
He has been engaged in semiconductor process integration, integrated power management, and 
system architecture for automotive and IoT applications. His current interests include on-chip 
power delivery, control theory, and design enablement at the Project Design Hub.
\end{IEEEbiography}
