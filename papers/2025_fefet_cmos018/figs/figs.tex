%===================== figs.tex (standalone: figures-only) =====================
...
% dashed highlight for FeFET module
...
%--------- Table I (centered; decent gap from Fig.1) ---------
\begin{table}[!b]
\centering
...
%--------- Fig.3 (Wake-up & Retention: side-by-side) ---------
\begin{figure}[!b]
\centering
...
%--------- Fig.4 (TDDB; will also fit on page 2) ---------
\begin{figure}[!h]
\centering
\begin{tikzpicture}
\begin{axis}[
