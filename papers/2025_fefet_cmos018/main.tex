...
\titlespacing{\subsubsection}{0pt}{*1.0}{*0.6}
...
Email: shin3t72@gmail.com,\quad GitHub: https://github.com/Samizo-AITL}
}
...
% =====================================================
% 図表を末尾にまとめて出力（PNG/PDF不要、全てLaTeXで描画）
\clearpage
...
\begin{figure*}[t]
  ...
  \begin{tikzpicture}[
    ...
    every node/.style={draw,rounded corners=2pt,inner sep=3pt,font=\footnotesize},
    arr/.style={-Latex,thick},
    box/.style={minimum width=5.2cm,align=center}
  ]
    \node[box] (a) {Active / Isolation};
    \node[box,below=of a] (b) {VT Adjust / Well};
    \node[box,below=of b] (c) {Poly Gate Definition};
    \node[box,below=of c] (d) {LDD / Spacer};
    \node[box,below=of d] (e) {Source/Drain Implant};
    \node[box,below=of e] (f) {Salicide (Co)};
    \node[box,below=of f,dashed,align=center] (g) {FeFET Gate-Last: IL/FE/CAP (ALD) + TiN (PVD/ALD)\\Crystallization RTA (450--500$^\circ$C) + FGA (350$^\circ$C)};
    \node[box,below=of g] (h) {ILD + Vias + BEOL};
    \draw[arr] (a) -- (b) -- (c) -- (d) -- (e) -- (f) -- (g) -- (h);
  \end{tikzpicture}
  \caption{Placement of FeFET module within the 0.18~$\mu$m CMOS baseline (vertical layout).}
  \label{fig:flow}
\end{figure*}

% --- Table I (横幅安定のため \textwidth 使用) ---
\begin{table*}[t]
\centering
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[mark=*,thick] coordinates {
        (1e2,1.60) (1e3,1.55) (1e4,1.48) (1e5,1.40) (1e6,1.32)
      };
      \addlegendentry{$\pm 2.5$ V, $10~\mu$s}

      \addplot[mark=square*,thick,densely dashed] coordinates {
        (1e2,1.58) (1e3,1.52) (1e4,1.46) (1e5,1.38) (1e6,1.30)
      };
...
% --- Fig.3: Wake-up & Retention (2サブプロット) ---
\begin{figure*}[t]
\centering
\begin{tikzpicture}
  \begin{axis}[
    width=0.42\textwidth,height=0.30\textwidth,
    ...
    \addplot[mark=*,thick] coordinates {(0,0.92) (30,0.975) (80,0.988) (150,0.994) (200,0.996)};
  \end{axis}
\end{tikzpicture}
\hfill
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[densely dashed] coordinates {(1e2,0.998) (1e6,0.94)};
  \end{axis}
\end{tikzpicture}
...
% --- Fig.4: TDDB Weibull (PGFPlots) ---
\begin{figure*}[t]
  \centering
  \begin{tikzpicture}
    \begin{axis}[
      width=0.85\textwidth,height=0.34\textwidth,
      ...
      \addplot[mark=*,thick] coordinates {(0.3,-1.9) (0.8,-0.7) (1.3,0.1) (2.0,1.0) (2.7,1.5)};
      \addlegendentry{Low $E$-field}
      \addplot[mark=square*,thick,densely dashed] coordinates {(0.25,-1.6) (0.9,-0.4) (1.4,0.4) (2.2,1.2) (2.8,1.9)};
