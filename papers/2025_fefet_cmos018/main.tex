...
% --- graphics: search path & preferred extensions (EPS first) ---
\graphicspath{{./}{figs/}}
...
% ==== Fig.1 then Table 1 (vertical order preserved) ====
\begin{figure}[H]
  \centering
  \includegraphics[width=0.42\textwidth]{fig1_flow} % <- no extension
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.42\textwidth]{fig2_endurance}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.42\textwidth]{fig3_wakeup}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.42\textwidth]{fig4_tddb}
