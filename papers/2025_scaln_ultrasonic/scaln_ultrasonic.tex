...
% ---------- Float control (位置が飛ばないように) ----------
\usepackage[section]{placeins} % 各 \section の境目で \FloatBarrier
\usepackage{stfloats}          % 2カラム時のフロート安定化（保険）
...
\begin{tikzpicture}
\begin{axis}[
  width=\columnwidth, height=4.6cm, % 少し縮めて収まりやすく
