...
\begin{figure}[t]
  \centering
  \begin{tikzpicture}[x=1mm,y=1.5mm] % ← 縦方向を1.5倍に
    % --- Poly ゲート電極 ---
    \draw[thick] (0,24) -- (70,24) node[right,font=\scriptsize]{Poly ゲート電極};

    % --- HV ゲート酸化膜 ---
    \draw[thick] (0,18) -- (70,18) node[right,font=\scriptsize]{HV ゲート酸化膜};

    % --- Si 基板 ---
    \draw[thick] (0,10) -- (70,10) node[right,font=\scriptsize]{Si 基板};

    % --- COP：菱形（内部ボイド） ---
    \draw[thick] (30,10) -- (31,12) -- (32,10) -- (31,8) -- cycle;
    \node[right,font=\scriptsize] at (33,10.5) {COP（析出＋ボイド）};

    % --- 接触位置を示す矢印（酸化膜界面） ---
    \draw[->,thin] (31,14.5) -- (31,12);
    \node[left,font=\scriptsize] at (27.5,14.5) {界面接触部};
