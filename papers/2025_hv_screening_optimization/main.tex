...
% ======================================================
% XeLaTeX を必須にする（CI側では latexmk_use_xelatex:true）
% ======================================================
\usepackage{iftex}
\ifXeTeX\else
...
% 和文（fonts-noto-cjk が Actions に入っている前提）
...
% 数式・図・表
% ======================================================
\usepackage{graphicx}            % dvipdfmx オプションは不要（XeLaTeX）
\graphicspath{{./}{figures/}}    % 図のパス
