...
\centering
\fitfig{%
\begin{tikzpicture}[>=Latex, node distance=2.2cm, y=0.55cm]
\tikzset{
  stage/.style={draw, rounded corners=2pt, minimum width=2.35cm, minimum height=0.75cm,
...
% stages
\node[stage] (n7)  at (0,0)   {7\,nm\\ FinFET\\ (2018)};
\node[stage] (n5)  at (3.0,0) {5\,nm\\ FinFET$\to$pre-GAA\\ (2020)};
\node[stage] (n3)  at (6.0,0) {3\,nm\\ GAA\\ (2023)};
\node[stage] (n2)  at (9.0,0) {2\,nm\\ GAA prod.\\ (2025 est.)};
\node[stage] (c20) at (12.0,0){$<$2\,nm\\ CFET\\ (2027--2030)};
\node[stage] (c10) at (15.0,0){1\,nm-class\\ Seq./Forksheet\\ (2030+)};
...
% compact annotations (下側のみ)
\node[annot] at (0,-1.2)  {VDD 0.70--0.80\,V\\ 90--100 MTr/mm$^2$};
\node[annot] at (3.0,-1.2){0.65--0.75\,V\\ 130--170};
\node[annot] at (6.0,-1.2){0.60--0.70\,V\\ 200--250};
\node[annot] at (9.0,-1.2){0.55--0.65\,V\\ 300--400};
\node[annot] at (12.0,-1.2){0.50--0.60\,V\\ 500--700};
\node[annot] at (15.0,-1.2){$<$0.50\,V\\ $>$800};

% key message（短い一行だけ）
\node[annot] at (12.0,1.0) {CFET: vertical n/p $\Rightarrow$ density $\sim$2$\times$, shorter n$\to$p RC};
