...
\node at (2,-0.2) {\scriptsize nMOS sheets (horizontal)};
...
\node at (1.2,0.8) {\scriptsize Dielectric fork};
...
Recent demonstrations by IMEC \cite{imec_cfet_iedm2020} highlight sequential CFET feasibility, but scaling reliability and yield remain open challenges.
...
While prototype Verilog-A implementations exist, they lack consensus and calibration.
Furthermore, no open-source CFET-ready PDKs or cell libraries are available, preventing standardized EDA flows.
This situation, while limiting, provides an educational sandbox for students to explore device-to-circuit modeling.
...
Looking forward, forksheet CFET layouts, 3D sequential stacks, and System-on-Stack architectures are promising research vectors.
Thermal-aware power partitioning and AI-driven design-space exploration will be critical to achieve manufacturable CFET integration.
Embedding CFET into curricula prepares future engineers to confront open problems at the frontier of scaling.
