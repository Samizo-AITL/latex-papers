...
% IEEEtranでは subfigure は非推奨。subfig を caption=false で使用
...
% ===== References =====
% bbl が空で \end{thebibliography} エラーを出さないよう暫定で埋める
% 本文に \cite{} が増えたら、この \nocite は削ってOK
\nocite{Franklin2015,Khalil2002,Anderson2007,Mayne2014,
        Kajita2003,Kuindersma2017,Paradiso2005,Brown2020}
