...
\begin{tikzpicture}[x=1mm,y=1.2mm] % ← 縦方向を少し拡大して重なり防止
  % ===== Layers =====
  \fill[gray!15] (0,0) rectangle (80,-14.0);        % Si substrate
  \fill[gray!55] (0,-14.0) rectangle (80,-13.5);    % Poly-Si electrode
  \fill[blue!20] (0,-13.5) rectangle (80,-12.9);    % ALD-Al2O3
  \fill[white] (0,-12.9) rectangle (80,-12.0);      % Gap
  \fill[yellow!35] (0,-12.0) rectangle (80,-11.1);  % SiNx diaphragm
  \fill[gray!60] (0,-11.1) rectangle (80,-10.9);    % Pt/Ti
  \fill[orange!20] (0,-10.9) rectangle (80,-9.9);   % Parylene-HT
  \fill[green!25] (0,-9.9) rectangle (80,-9.8);     % PEG-SAM

  % Outline
  \draw[thick] (0,0) rectangle (80,-14.0);

  % --- Labels (整列と重なり防止) ---
  \node[anchor=west,font=\scriptsize] at (82,-7.0) {Si(100) substrate};
  \node[anchor=west,font=\scriptsize] at (82,-13.7) {Poly-Si (0.2 µm)};
  \node[anchor=west,font=\scriptsize] at (82,-13.1) {ALD-Al$_2$O$_3$ (60 nm)};
  \node[anchor=west,font=\scriptsize] at (82,-12.4) {Gap (0.8–1.0 µm)};
  \node[anchor=west,font=\scriptsize] at (82,-11.5) {SiN$_x$ diaphragm (0.8 µm, +150 MPa)};
  \node[anchor=west,font=\scriptsize] at (82,-10.95) {Pt/Ti (100/20 nm)};
  \node[anchor=west,font=\scriptsize] at (82,-10.2) {Parylene-HT (1.0 µm)};
  \node[anchor=west,font=\scriptsize] at (82,-9.7) {PEG-SAM};

  % --- Electric field arrows ---
  \foreach \x in {10,25,40,55,70} {
    \draw[->,blue!60,thick] (\x,-11.3) -- (\x,-12.7);
  }
  \node[anchor=west,font=\scriptsize,blue!60] at (2,-9.3) {Electrostatic field $E$};

  % --- Displacement arrow ---
  \draw[->,red!70!black,thick] (12,-11.8) -- (12,-12.6);
  \node[anchor=east,font=\scriptsize,red!70!black] at (11.5,-12.2) {膜変位 $\Delta x$};
\end{tikzpicture}}
\caption{アクチュエータ積層構造。
