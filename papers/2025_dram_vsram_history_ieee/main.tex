...
\begin{axis}[
    ...
    ylabel={歩留まり（\%）},
    ymin=0, ymax=100,
    xtick={0.5,0.35,0.25,1},
    xticklabels={0.5$\mu$m,0.35$\mu$m,0.25$\mu$m,VSRAM},
    legend style={
        at={(0.5,-0.25)}, % ← 凡例の位置（x=中央, y=グラフ下）
        anchor=north,
        legend columns=2
    },
    grid=major
]
\addplot[mark=*] coordinates {(0.5,95) (0.35,20) (0.25,65) (1,35)};
\addlegendentry{初期歩留まり};

\addplot[mark=square*] coordinates {(0.5,95) (0.35,65) (0.25,85) (1,75)};
\addlegendentry{改善後};
