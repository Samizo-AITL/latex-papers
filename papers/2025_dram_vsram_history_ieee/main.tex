...
\begin{axis}[
  ...
  xticklabels={
    $0.5\,\mu\mathrm{m}$ (16M),
    $0.35\,\mu\mathrm{m}$ (64M),
    $0.25\,\mu\mathrm{m}$ (64M),
    VSRAM
  },
  x tick label style={align=center, text width=2.9cm},
  grid=both,
  legend style={
  ...
  \addplot+[semithick,mark=*]
    coordinates {(1,95) (2,20) (3,65) (4,30)};
  \addlegendentry{初期}

  % 改善後
  \addplot+[semithick,mark=square*]
    coordinates {(1,95) (2,86) (3,88) (4,80)};
  \addlegendentry{改善後}
\end{axis}
\end{tikzpicture}
\caption{酒田Fabにおける世代別歩留まり推移（凡例はグラフ下中央）。}
\label{fig:yield_all}
\end{figure}
