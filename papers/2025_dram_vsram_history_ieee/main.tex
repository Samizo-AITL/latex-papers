...
% --- 基板 ---
\fill[gray!20] (-1,0) rectangle (4,-1.2);
\node at (-0.8,-0.6) {$p^-$ substrate};

% --- n+拡散層 ---
\fill[gray!50] (1,-0.01) rectangle (3,-0.4);
\node at (2,-0.6) {$n^+$ diffusion};

% --- ストレージノードコンタクト ---
\draw[fill=white] (2,-0.01) rectangle (2.4,1.2);
\node at (2.7,0.6) {SN};

% --- 矢印：n+ から p- へのリーク ---
\draw[->,thick,red] (2,-0.4) -- (2,-1.0)
  node[midway,right] {$I_{\mathrm{leak}}$};

% --- ラベル ---
\draw[->] (2.2,1.2) -- (2.2,1.6) node[above] {to Storage Node};
