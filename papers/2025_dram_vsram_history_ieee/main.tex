...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \fill[gray!55] (-1.00,0) rectangle (1.00,-0.65);               % n+ diffusion（細め）
  \fill[black!30] (-0.25,0) rectangle (0.25,1.00);               % SN contact
  \draw[red,very thick] (-1.00,0) -- (-1.00,-0.65) -- (1.00,-0.65) -- (1.00,0); % 接合周辺
\end{tikzpicture}
\caption*{(a) Stack Cross-section}   % ← Fig. 番号は出ません
