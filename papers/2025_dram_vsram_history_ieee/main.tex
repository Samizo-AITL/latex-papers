...
\begin{axis}[
  ...
  xmin=1, xmax=4,
  xtick={1,2,3,4},
  xticklabels={0.5\,$\mu$m (16M), 0.35\,$\mu$m (64M), 0.25\,$\mu$m (64M), VSRAM},
  x tick label style={align=center}, % 折返し防止
  grid=both
]
  % 初期値
  \addplot+[mark=*] coordinates {(1,100) (2,20) (3,65) (4,35)};
  \addlegendentry{初期}

  % 改善後
  \addplot+[mark=square*] coordinates {(1,100) (2,86) (3,88) (4,80)};
  \addlegendentry{改善後}
\end{axis}
\end{tikzpicture}
\caption{酒田Fabにおける世代別歩留まり推移（0.5\,\textmu m～VSRAM）。}
\label{fig:yield25}
\end{figure}
...
\begin{figure}[t]
\centering
\begin{tikzpicture}[x=1cm,y=1cm,scale=0.85] % ←必要なら0.8～0.9で調整

% ==== (a) Stack Cross-section ====
\begin{scope}[yshift=2.8cm]
  \fill[gray!20] (-1.6,0) rectangle (1.6,-0.8); % substrate
  \fill[gray!55] (-0.55,0) rectangle (0.55,-0.6); % n+ diffusion
  \fill[black!30] (-0.18,0) rectangle (0.18,1.0); % electrode
  \draw[red,very thick] (-0.55,0) -- (-0.55,-0.6);
  \draw[red,very thick] (0.55,0) -- (0.55,-0.6);
  \draw[red,very thick] (-0.55,-0.6) -- (0.55,-0.6);
  \node[anchor=north] at (0,-1.05) {\bfseries (a) Stack Cross-section};
\end{scope}

% ==== (b) Trench Cross-section ====
\begin{scope}[yshift=0cm]
  \fill[gray!20] (-1.6,0) rectangle (1.6,-2.0); % substrate
  \draw[black,thick] (-0.55,0) -- (-0.55,-1.6) -- (0.55,-1.6) -- (0.55,0); % trench
  \fill[black!30] (-0.38,-0.1) rectangle (0.38,-1.5); % electrode
  \fill[gray!55] (0.60,-0.6) rectangle (1.00,-1.0); % buried strap
  \draw[red,very thick] (0.60,-0.6) rectangle (1.00,-1.0); % pn junction
  \node[anchor=north] at (0,-2.2) {\bfseries (b) Trench Cross-section};
\end{scope}

% ==== (c) Stack Top view ====
\begin{scope}[xshift=-3.5cm, yshift=-4.6cm]
  \fill[gray!20] (-1.5,-1.5) rectangle (1.5,1.5);
  \fill[gray!55] (-0.9,-0.9) rectangle (0.9,0.9);
  \fill[black!30] (-0.35,-0.35) rectangle (0.35,0.35);
  \draw[red,very thick] (-0.9,-0.9) rectangle (0.9,0.9);
  \node[anchor=north] at (0,-1.9) {\bfseries (c) Stack Top view};
\end{scope}

% ==== (d) Trench Top view ====
\begin{scope}[xshift=3.5cm, yshift=-4.6cm]
  \fill[gray!20] (-1.5,-1.5) rectangle (1.5,1.5);
  \draw[black,thick] (-0.9,-0.9) rectangle (0.9,0.9); % trench
  \fill[black!30] (-0.55,-0.55) rectangle (0.55,0.55); % electrode
  \fill[gray!55] (0.95,-0.35) rectangle (1.35,0.35); % strap
  \draw[red,very thick] (0.95,-0.35) rectangle (1.35,0.35);
  \node[anchor=north] at (0,-1.9) {\bfseries (d) Trench Top view};
\end{scope}

\end{tikzpicture}

\caption{Stack/Trench キャパシタの断面(a)(b)と上面(c)(d)比較。Stackは接合周辺長が限定的，Trenchはburied strap起点で接合周辺長が増える。}
