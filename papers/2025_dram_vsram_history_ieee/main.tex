...
% --- 基板 (p-) ---
\fill[gray!20] (-1,0) rectangle (4,-1.0);
\node at (-0.8,-0.5) {\small $p^-$ substrate};

% --- n+拡散層 ---
\fill[gray!50] (1,-0.01) rectangle (3,-0.4);
\node at (2,-0.6) {\small $n^+$ diffusion};

% --- ストレージノードコンタクト ---
\draw[fill=white,thick] (2,-0.01) rectangle (2.4,1.2);
\node at (2.7,0.6) {Storage Node Contact};

% --- リーク電流の矢印 ---
\draw[->,thick,red] (2.2,-0.2) -- (2.2,-1.0)
  node[midway,right] {\small $I_{\mathrm{leak}}$};
