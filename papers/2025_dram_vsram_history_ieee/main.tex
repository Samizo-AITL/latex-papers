...
Table~\ref{tab:resist_flow} に従来フローと対策後の切替内容を示す。
この切替により，Pause Refresh Fail は大幅に減少し，
量産歩留まりは 65\% から 80\%台後半へと改善した（Fig.~\ref{fig:yield_trend}）。
...
特に 90\,$^\circ$C 条件下では，短チャネルデバイスでの影響が支配的となった。
