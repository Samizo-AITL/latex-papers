...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm, every node/.style={font=\scriptsize}]
    % n-well region
    \fill[blue!10] (-0.2,-1.2) rectangle (6.2,0);
    \draw (-0.2,-1.2) rectangle (6.2,0);
    \node[anchor=west] at (6.25,-0.6) {n-well (HV PMOS領域)};

    % STI trench oxide
    \fill[gray!35] (0,0) -- (0,-1.0) -- (0.6,-1.0) -- (0.6,0) -- cycle;
    \draw (0,0) -- (0,-1.0) -- (0.6,-1.0) -- (0.6,0);
    \node at (0.3,-1.15) {STI酸化膜};

    % Active silicon surface
    \draw[thick] (0.6,0) -- (6.0,0);

    % Thick gate oxide (HV)
    \fill[green!30] (1.3,0) rectangle (3.7,0.08);
    \node[green!40!black,anchor=south] at (2.5,0.1) {厚ゲート酸化膜};

    % Edge thinning near STI
    \fill[red!55] (0.6,0) -- (1.3,0) -- (1.3,0.08) -- (0.8,0.02) -- (0.6,0.0) -- cycle;
    \node[red!70!black, anchor=south west] at (0.62,0.08) {端部シンニング};

    % Poly gate
    \fill[gray!20] (1.0,0.08) rectangle (4.0,0.40);
    \draw (1.0,0.08) rectangle (4.0,0.40);
    \node at (2.5,0.48) {ポリシリコンゲート};

    % Spacers
    \fill[gray!50] (1.0,0.08) rectangle (1.2,0.35);
    \fill[gray!50] (3.8,0.08) rectangle (4.0,0.35);
    \node at (0.9,0.25) {SiNスペーサ};

    % LDD extensions
    \fill[pink!40] (0.9,-0.02) rectangle (1.2,-0.25);
    \fill[pink!40] (3.8,-0.02) rectangle (4.1,-0.25);
    \node at (1.05,-0.35) {p$^{-}$ LDD};
    \node at (3.95,-0.35) {p$^{-}$ LDD};

    % Source / Drain (p+ implants)
    \fill[pink!70] (0.6,-0.05) rectangle (0.9,-0.35);
    \fill[pink!70] (4.1,-0.05) rectangle (4.6,-0.35);
    \draw (0.6,-0.05) rectangle (0.9,-0.35);
    \draw (4.1,-0.05) rectangle (4.6,-0.35);
    \node at (0.75,-0.5) {p$^{+}$ S};
    \node at (4.35,-0.5) {p$^{+}$ D};

    % Channel
    \fill[white] (1.2,-0.02) rectangle (3.8,-0.18);
    \draw (1.2,-0.02) rectangle (3.8,-0.18);
    \node at (2.5,-0.32) {チャネル};

    % High-field region near STI
    \fill[red!15,draw=red!60,dashed] (0.6,0) -- (1.0,0) -- (1.0,-0.15) -- (0.7,-0.15) -- cycle;
    \node[red!70!black, anchor=north west] at (1.02,-0.02) {高電界集中};

    % Leakage arrow
    \draw[->,very thick,red!80] (0.9,0.28) to[out=-90,in=90] (0.85,0.02);
    \node[red!80,anchor=west] at (0.95,0.20) {ゲートリーク経路};

    % Labels
    \node[anchor=south] at (2.5,0.42) {Gate};
    \node[anchor=north] at (0.75,-0.38) {Source};
    \node[anchor=north] at (4.35,-0.38) {Drain};

    % HV annotation
    \draw[<->] (2.2,0.65) -- (2.8,0.65);
    \node at (2.5,0.82) {30 V級 HV PMOS};
  \end{tikzpicture}
  \caption{HV PMOSにおけるSTI端部シンニングとゲートリーク模式断面}
  \label{fig:hvpmos_sti}
\end{figure}
