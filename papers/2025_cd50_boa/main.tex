...
\begin{tikzpicture}[x=1.5cm,y=1.5cm, every node/.style={font=\scriptsize}]
  ...
  \node[red!80,anchor=west] at (1.05,0.0) {\small Leakage};

  \end{scope}
\end{tikzpicture}
\caption{STI端部におけるゲート酸化膜シンニングとリーク経路。PolyはSTI上／薄膜上／通常膜上で段差構造を形成し、各ラベルを領域中央に配置。}
\label{fig:sti_edge_leakage_final}
\end{figure}
