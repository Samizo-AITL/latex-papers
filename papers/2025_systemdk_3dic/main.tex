...
\usepackage{listings}
\usepackage{color}
\usepackage{tabularx}   % 幅いっぱいで自動折返し
...
% --- Table I: stays two-column layout; table spans across both columns ---
\begin{table*}[t]
\centering
\caption{Mapping FEM and S-parameter results into SystemDK constraints}
\label{tab:mapping}
\setlength{\tabcolsep}{6pt}          % 列間
\renewcommand{\arraystretch}{1.25}   % 行間（縦を広げる）
\footnotesize                        % 読みやすいサイズ
