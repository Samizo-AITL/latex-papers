...
\bibitem{hotspot2019} H. Huang et al., ``Hotspot-aware placement for 3D ICs,'' in \textit{Proc. ICCAD}, 2019.
\bibitem{stressaware2021} K. Obata et al., ``Stress-aware static timing analysis in TSV-based 3D ICs,'' in \textit{Proc. ASP-DAC}, 2021.
\bibitem{emicts2020} S. Lee et al., ``EMI-aware clock tree synthesis for multi-GHz SoCs,'' in \textit{Proc. DAC}, 2020.
\bibitem{chiplet2023} T. Han et al., ``Design methodology for chiplet-based heterogeneous integration,'' \textit{IEEE Trans. VLSI}, vol. 31, no. 4, pp. 455–468, 2023.
\end{thebibliography}
