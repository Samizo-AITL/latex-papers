...
\setmainfont{TeX Gyre Termes}   % 英文 Times 系
\setsansfont{TeX Gyre Heros}
\setmonofont{TeX Gyre Cursor}
\setmainjfont{IPAexMincho}      % 和文（TeX Live 標準）
% \setmainjfont{HaranoAjiMincho} % ←太字警告を減らしたいならこちらも可

\usepackage{newtxmath}          % 数式を Times 系に（AMS 記号も含む）
