...
% Optional: if you later export PDFs to figs/pdfs, add both to the path
...
\begin{figure}[!t]
  \centering
  % standalone TikZ sources under figs/
  \includestandalone[width=\linewidth]{figs/actuation_modes_tikz}
...
\begin{figure}[!t]
  \centering
  \includestandalone[width=\linewidth]{figs/droplet_instability_tikz}
...
\begin{figure}[!t]
  \centering
  \includestandalone[width=\linewidth]{figs/ink_classification_tikz}
...
\begin{figure}[!t]
  \centering
  \includestandalone[width=\linewidth]{figs/system_flow_tikz}
...
\begin{figure}[!t]
  \centering
  \includestandalone[width=\linewidth]{figs/piezo_materials_tikz}
...
\begin{figure*}[!t]
  \centering
  \includestandalone[width=0.9\textwidth]{figs/application_matrix_tikz}
...
%==============================================================================
% (Optional) Appendix: repository screenshots — remove for submission if not needed.
\section*{Appendix: Repository Context (Illustrative Figures)}
\begin{figure}[!t]
  \centering
  % Place JPEGs to figs/ (or comment out for submission)
  \includegraphics[width=\linewidth]{github_papers.jpeg}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=\linewidth]{github_workflows.jpeg}
  \caption{Example GitHub Actions workflow directory for automated PDF builds.}
  \label{fig:workflows}
\end{figure}

%==============================================================================
% References (placeholder style; replace with your BibTeX/IEEE items)
