...
The following screenshots illustrate a typical repository layout used to manage \LaTeX{} sources and CI builds (GitHub Actions). They are not essential to the technical content but help reproducibility.
...
\bibitem{Park2010}
J.-U.~Park and et al., ``High-resolution electrohydrodynamic jet printing,'' \emph{Nature Materials}, vol.~6, pp.~782--789, 2007.
\end{thebibliography}
