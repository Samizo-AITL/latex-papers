\begin{table*}[t]
  ...
  \setlength{\tabcolsep}{3pt}        % 列間を詰めて全体幅調整
  \renewcommand{\arraystretch}{1.05} % 行間微調整
  \scriptsize                       % フォントサイズ調整（1段階小）
  \begin{tabular}{ccccccc}
    \toprule
    ノード / \textbf{Node} & 構造 / \textbf{Structure} & 電源電圧 / \textbf{$V_\mathrm{DD}$} &
    \textbf{$T_\mathrm{ox}$ [nm]} & 最小L / \textbf{Min L [nm]} &
