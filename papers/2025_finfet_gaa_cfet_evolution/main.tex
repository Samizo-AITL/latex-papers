...
% パッケージ設定
% -----------------------------------------------------
\usepackage{fontspec}         % XeLaTeX用（inputenc不要）
\usepackage{xeCJK}            % 日本語対応
\setCJKmainfont{IPAexMincho}  % 日本語本文フォント（明朝体）
\setmainfont{TeX Gyre Termes} % 欧文フォント（Times系）
...
\hypersetup{
  ...
  pdftitle={Semiconductor Device Scaling Report}
}
