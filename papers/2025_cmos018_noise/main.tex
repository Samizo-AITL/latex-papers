...
Test MOSFETs ($L=\SI{0.18}{\micro\meter}$, $W=\SI{10}{\micro\meter}$) were built in baseline and improved splits. PSD was measured from \SI{1}{Hz} to \SI{10}{kHz} at $V_{GS}=\SI{0.5}{V}$, $V_{DS}=\SI{50}{mV}$ for \SI{25}{\celsius}–\SI{125}{\celsius}.
