...
\DeclareSIUnit{\um}{\micro\meter} % 便利マクロ

% --- IEEEtran + XeLaTeX では不要なので削除 ---
...
% ---------- Figure 4: Long-term (1-column, bottom-left) ----------
% \FloatBarrier   % ←削除（バリアが詰まりの原因）
\begin{figure}[!b]  % ← [!t] を [!b] に変更して左カラムの“下”へ
\centering
\begin{tikzpicture}
\begin{axis}[
  width=\linewidth, height=5cm,
