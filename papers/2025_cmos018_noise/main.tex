...
\begin{loglogaxis}[
  ...
  xmin=1, xmax=1e4, ymin=1e-5, ymax=1e-1,
  grid=both,
  legend pos=north east,
  legend style={font=\small, cells={anchor=west}}
]
% --- Baseline ---
\addplot+[thick, blue, mark=none] table[row sep=\\] {%
x y\\
1    1e-1\\
3    3.3e-2\\
10   1e-2\\
...
% --- Improved ---
\addplot+[thick, red, mark=none] table[row sep=\\] {%
x y\\
1    5e-2\\
3    1.65e-2\\
10   5e-3\\
...
\begin{axis}[
  ...
  grid=both,
  legend pos=mid right,
  legend style={font=\small, cells={anchor=west}}
]
% --- Baseline ---
\addplot+[thick, blue, mark=none] coordinates {
  (0,1.0) (200,1.05) (500,1.12) (1000,1.20)
};
\addlegendentry{Baseline}

% --- Improved ---
\addplot+[thick, red, mark=none] coordinates {
  (0,0.6) (200,0.61) (500,0.60) (1000,0.60)
};
