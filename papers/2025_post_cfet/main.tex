% main.tex : Post-CFET paper (IEEEtran, two-column) — detailed version
...
\sisetup{detect-all,per-mode=symbol,range-phrase = \text{--},range-units=single}
...
\bibitem{ferr2020} A. Fert, \etal, \emph{Rev. Mod. Phys.}, 2019.
...
% ---------- Fallback Biography (conference用に見せたい場合は以下を使う) ----------
