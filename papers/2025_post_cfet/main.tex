% --------------------------------------------------
% Post-CFET Device Architecture Paper (English Version, Final Revised)
% --------------------------------------------------
...
\usepackage[section]{placeins}       % float制御
\usepackage{balance}                 % 文末段バランス調整
...
\FloatBarrier % Abstractより上に図が来ないように
