% --------------------------------------------------
% Post-CFET Device Architecture Paper (English Version, Fixed)
% --------------------------------------------------
...
% ※ placeins は外す。figure* を多用する場合は末尾で \clearpage を使う。
...
\tikzset{
  ...
  title/.style={font=\bfseries}, % for label text etc.
...
% ======= Wide figures are collected at the end =======
