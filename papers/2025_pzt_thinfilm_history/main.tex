...
% =====================================================
% XeLaTeX + CJK (robust universal setup)
% =====================================================
\usepackage{fontspec}    % Unicode font management
\usepackage{xeCJK}       % Japanese / Chinese / Korean typesetting
...
% ---------- Japanese fonts (robust fallback) ----------
% Prefer HaranoAji if installed; fallback to Noto CJK JP
\IfFontExistsTF{HaranoAjiMincho}{
  ...
  \IfFontExistsTF{Noto Serif CJK JP}{
    ...
    \setCJKmainfont{IPAMincho} % 最後の保険（IPAexでもOK）
  }
}
...
% ---------- Line breaking / punctuation ----------
\xeCJKsetup{
  CJKglue=\hskip 0.2em plus 0.1em minus 0.05em,
  PunctStyle=plain
}
...
% ---------- Safe em-dash macro ----------
\newcommand{\Jemdash}{—} % use U+2014 (safe em dash)
% ※ U+2015 の「水平棒」はフォント欠落しやすいため使用禁止。
% 例：タイトル中は "技術の系譜 \Jemdash FeRAMからPrecisionCoreへ"
