...
% ▼ 修正ポイント：表幅を\columnwidthに制限して自動調整
...
\footnotesize % ← フォントを一段小さく（表が自然に収まる）
\setlength{\tabcolsep}{3pt} % ← カラム間を少し詰める
\begin{tabular}{@{}p{1.6cm}p{2.6cm}p{4.9cm}@{}} % ← 各列幅を明示指定
\toprule
\textbf{年代} & \textbf{技術系統} & \textbf{主要イベント・内容} \\ \midrule
1984--1990 & FeRAM起源（Ramtron） &
Sol--gel法＋RTAによるSi上PZT薄膜形成を確立し，
強誘電体メモリ化を実現。\\[3pt]
1990--2005 & 日本導入期 &
富士見NVプロジェクトでFeRAM開発，
...
2010--2012 & 技術転換 &
ポーリング短縮を目的に
\textbf{下部電極駆動}（共通上部電極COM）構造を採用。\\[3pt]
