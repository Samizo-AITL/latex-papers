...
% ---------- Packages (robust for XeLaTeX + CJK) ----------
\usepackage{fontspec}    % XeLaTeX font backend
\usepackage{xeCJK}       % Japanese (CJK)

% --- English fonts (any TeX Live has these) ---
\setmainfont{TeX Gyre Termes}
\setsansfont{TeX Gyre Heros}
\setmonofont{TeX Gyre Cursor}

% --- Japanese fonts with fallback (TeX Live stock) ---
% Prefer HaranoAji; fall back to Noto CJK if unavailable
...
% --- Safe dash (avoid U+2015 issues in some fonts) ---
\newcommand{\Jemdash}{—} % use U+2014 em dash
% 例: タイトルのダッシュは \Jemdash にする
