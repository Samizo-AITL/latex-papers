...
\begin{tikzpicture}[x=1mm,y=1mm,font=\footnotesize]
  % Time axis
  \draw[->,thick] (0,0) -- (100,0) node[right]{Year};
  \foreach \x/\y in {0/1984,25/1995,55/2007,85/2025}
    \draw[thick] (\x,0) -- (\x,-1.5) node[below]{\y};
  % Branches
  \draw[thick,blue!70] (0,5) -- (25,5) node[midway,above]{FeRAM (Ramtron)};
  \draw[thick,blue!70] (25,5) -- (55,10) node[midway,above]{FeRAM→NV Project};
  \draw[thick,red!70] (25,5) -- (55,0) node[midway,below]{TFP (P Project)};
  \draw[thick,red!70] (55,0) -- (85,0) node[midway,below]{μTFP / PrecisionCore};
  % Merge arrow
  \draw[->,thick,gray!60] (55,2.5) -- (55,0.2);
\end{tikzpicture}
