...
System-level analysis shows that FeRAM chiplets can reduce standby power by suppressing DRAM refresh, shorten resume latency to the $\mu$s range, and improve overall energy efficiency for mobile edge AI workloads.
\end{abstract}
