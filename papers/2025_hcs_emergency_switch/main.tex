...
\usepackage{iftex}
\ifPDFTeX
  \errmessage{This document must be compiled with XeLaTeX (or LuaLaTeX).}
\fi
...
% IPAex が無いCI対策でフォールバック
\newif\ifHaveIPA
\IfFontExistsTF{IPAexMincho}{\HaveIPAtrue}{\HaveIPAfalse}
\ifHaveIPA
  \setCJKmainfont{IPAexMincho}
\else
  \IfFontExistsTF{Noto Serif CJK JP}{\setCJKmainfont{Noto Serif CJK JP}}{\setCJKmainfont{IPAMincho}}
\fi
% 日本語行分割
...
% ===== Links (最後に) =====
\PassOptionsToPackage{hyphens}{url} % 長いURLの自動改行
\usepackage{url}
