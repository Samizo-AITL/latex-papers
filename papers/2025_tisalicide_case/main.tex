...
\begin{figure*}[!t]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      % SW (widened right), left edge aligned with substrate
      ...
      % halo (inside Si, top at y=0)
      \draw[halo] (1.60,-0.20) ellipse (0.55 and 0.20);
      \node[label,blue!60] at (1.60,-0.48) {halo};

      % C49+B residual: slightly right, near halo top
      \draw[residual] (1.78,0.00) circle (0.10);
      \node[label,red!70] at (2.30,0.18) {C49+B residual};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}]
      ...
      % SW (same width as a) — no white foot recess
      \path[fill=gray!50] (0,0) rectangle (1.2,1.6);
      \node[label] at (0.6,1.8) {SW};
      ...
      % halo entirely under SW (inside Si)
      \draw[halo] (0.60,-0.20) ellipse (0.55 and 0.20);
      \node[label,blue!60] at (0.60,-0.48) {halo};

      % no residual label
      \node[label,green!50!black] at (2.2,-0.30) {no C49+B residual};
    \end{scope}
  \end{tikzpicture}}
  \caption{Cross-sections near a sidewall (SW) based on the sketch. 
  (a) Halo resides within Si and meets the surface at the SW corner; a C49+B residual forms at the halo-top/edge region. 
  (b) After the sidewall process, halo remains under the SW and away from the TiSi front, eliminating the residual.}
