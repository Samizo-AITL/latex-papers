...
\begin{figure}[!t]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \node at (2.5,1.8) {STI Oxide};
    % Silicon substrate
    \fill[gray!10] (0,-2) rectangle (5,0);
    \node at (2.5,-1.5) {Si Substrate};
    % Halo implant region
    \fill[blue!30] (1.2,-0.2) ellipse (0.8 and 0.4);
    \node[blue] at (1.2,0.4) {Halo B};
    % Ti layer
    \fill[orange!40] (0,2) rectangle (5,2.3);
    \node at (2.5,2.5) {Ti layer};
    % Label defective case
    \node[red] at (3.5,0.5) {C49 residual};
  \end{tikzpicture}
  \caption{Schematic cross-section of halo implant diffusion beneath the STI sidewall contacting Ti during silicidation. Sidewall under-etch increases separation, suppressing C49 residual grains.}
