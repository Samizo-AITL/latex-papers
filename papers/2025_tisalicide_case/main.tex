...
\begin{figure*}[!t]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
    ...
    \tikzstyle{residual}=[fill=red!70,draw=red!80!black,opacity=0.95]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      % Halo：SW直下（右端がTiSiにわずか接触）
      \draw[halo] (0.75,-0.25) ellipse (0.65 and 0.25);
      \node[label,blue!70] at (0.75,-0.55) {halo};

      % C49+B 高抵抗スポット（接触点付近を強調）
      \draw[residual] (1.03,0.03) circle (0.10);
      \node[label,red!70] at (1.58,0.22) {high-R spot (C49+B)};
    \end{scope}
