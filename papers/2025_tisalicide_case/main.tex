...
\begin{figure*}[!t]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      % sidewall (SW) -- widened to the right
      ...
      % halo (still right side)
      \draw[halo] (1.6,-0.05) ellipse (0.55 and 0.25);
      \node[label,blue!60] at (2.4,0.3) {halo};

      % C49 + B residual
      \draw[residual] (1.2,0.0) circle (0.10);
      \node[label,red!70] at (2.2,-0.3) {C49+B residual};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}]
      ...
      % sidewall (SW) -- widened to fully cover halo
      \path[fill=gray!50] (0,0) rectangle (1.2,1.6);
      \node[label] at (0.6,1.8) {SW};

      % foot recess (etch-back at bottom corner)
      \fill[white] (0,0) -- (0.4,0) -- (0.4,0.20) -- (0,0.20) -- cycle;

      % TiSi silicide
      \path[silicide] (1.2,-0.05) rectangle (6,0.10);
      \node[label] at (5.0,0.25) {TiSi};

      % halo (now positioned under SW)
      \draw[halo] (0.6,-0.05) ellipse (0.55 and 0.25);
      \node[label,blue!60] at (1.4,0.3) {halo};

      % separation arrow
      \draw[<->,thick,gray!70] (1.2,0.15) -- (1.6,0.15);
      \node[label] at (1.4,0.35) {separation};

      % no residual
      \node[label,green!50!black] at (2.2,-0.3) {no C49+B residual};
    \end{scope}
  \end{tikzpicture}}
