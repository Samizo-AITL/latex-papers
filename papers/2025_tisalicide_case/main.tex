...
% ===== Fig.2: poly + SW cross-sections (clean version) =====
\begin{figure*}[!t]
  \centering
  \resizebox{\textwidth}{!}{%
  \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      % halo (共通サイズ) – 右端TiSi接触
      \draw[halo] (0.78,-0.25) ellipse (0.65 and 0.25);
    ...
    \begin{scope}[shift={(8,0)}]
      ...
      % halo (同じサイズ, 非接触)
      \draw[halo] (0.70,-0.25) ellipse (0.65 and 0.25);
      \node[label,blue!70] at (0.70,-0.56) {halo};
      \node[label,green!50!black] at (2.2,-0.30) {no C49+B residual (no contact)};
    \end{scope}
  \end{tikzpicture}}
  \caption{Cross-sections near poly and sidewall (SW). (a) Halo under SW barely touches TiSi edge, forming a high-resistance C49+B spot. (b) With SW under-etch and slightly wider SW, halo stays under SW and avoids TiSi contact, eliminating the defect.}
  \label{fig:fig2_poly}
\end{figure*}
