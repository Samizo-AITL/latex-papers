...
\midrule
Isolation method & Thick field oxide (LOCOS); proven HV margin & Shallow trench isolation; edge thinning at HV corners \\
...
Yield stability & Moderate: yield impacted by TiSi$_2$ instability & Generally stable baseline process \\
Embedded SRAM redundancy & Not implemented (design/area/timing overhead); no laser repair in mixed-signal testers & Same limitation; redundancy infeasible in LCD driver IC test flow \\
...
Adoption rationale & Safe HV compatibility outweighed cost/density & Density/yield advantage offset by HV risk; not adopted \\
\bottomrule
\end{tabular}
\end{table*}
