...
\begin{figure*}[!t]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      % Poly gate
      \path[poly] (1.0,0) rectangle (1.6,1.2); \node[label] at (1.3,1.35) {poly};
      % Sidewall oxide
      \path[fill=gray!50] (1.6,0) rectangle (2.0,1.2); \node[label] at (1.8,1.35) {SW};
      % Silicide on poly and diffusion
      \path[silicide] (1.0,1.2) rectangle (1.6,1.35);
      \path[silicide] (2.0,-0.05) rectangle (6,0.10); \node[label] at (5.0,0.25) {TiSi};
      % Halo implant (ellipse below poly/SW corner)
      \draw[halo] (1.4,-0.25) ellipse (0.6 and 0.25);
      \node[label,blue!60] at (1.4,-0.55) {halo};
      % Residual defect at contact point
      \draw[residual] (1.95,0.02) circle (0.10);
      \node[label,red!70] at (2.5,0.2) {high-R spot};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}]
      ...
      % Poly gate
      \path[poly] (1.0,0) rectangle (1.6,1.2); \node[label] at (1.3,1.35) {poly};
      % Sidewall oxide (etched back -> narrower at bottom)
      \path[fill=gray!50] (1.6,0.3) -- (2.0,0.3) -- (2.0,1.2) -- (1.6,1.2) -- cycle;
      \node[label] at (1.8,1.35) {SW};
      % Silicide on poly and diffusion
      \path[silicide] (1.0,1.2) rectangle (1.6,1.35);
      \path[silicide] (2.0,-0.05) rectangle (6,0.10); \node[label] at (5.0,0.25) {TiSi};
      % Halo implant (still under poly/SW but not touching TiSi)
      \draw[halo] (1.4,-0.25) ellipse (0.6 and 0.25);
      \node[label,blue!60] at (1.4,-0.55) {halo};
      % 注記：no residual
      \node[label,green!50!black] at (2.6,-0.25) {no C49+B residual};
    \end{scope}
  \end{tikzpicture}}
  \caption{Cross-sections near poly and sidewall (SW). (a) Halo touches TiSi at the SW corner, forming a high-resistance C49+B spot. (b) After SW under-etch, halo remains under SW but does not contact TiSi, eliminating the defect.}
  \label{fig:fig2_poly}
\end{figure*}
