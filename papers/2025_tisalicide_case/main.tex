...
\begin{figure*}[!t]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      % sidewall (SW)
      \path[fill=gray!50] (2.5,0) rectangle (3.0,1.6);
      \node[label] at (2.75,1.8) {SW};

      % TiSi silicide
      \path[silicide] (3.0,-0.05) rectangle (6,0.10);
      \node[label] at (5.0,0.25) {TiSi};

      % halo
      \draw[halo] (2.6,-0.05) ellipse (0.5 and 0.25);
      \node[label,blue!60] at (1.9,0.3) {halo};

      % C49 + B residual (at contact point)
      \draw[residual] (3.0,0.0) circle (0.10);
      \node[label,red!70] at (3.7,0.3) {C49+B residual};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}]
      ...
      % sidewall (SW with foot recess)
      \path[fill=gray!50] (2.5,0) rectangle (3.0,1.6);
      \node[label] at (2.75,1.8) {SW};
      % foot recess (small cut at bottom corner)
      \fill[white] (2.5,0) -- (2.7,0) -- (2.7,0.15) -- (2.5,0.15) -- cycle;

      % TiSi silicide
      \path[silicide] (3.0,-0.05) rectangle (6,0.10);
      \node[label] at (5.0,0.25) {TiSi};

      % halo (shifted right, separated)
      \draw[halo] (3.4,-0.05) ellipse (0.55 and 0.25);
      \node[label,blue!60] at (4.2,0.3) {halo};

      % distance arrow
      \draw[<->,thick,gray!70] (3.0,0.15) -- (3.4,0.15);
      \node[label] at (3.2,0.35) {separation};

      % no residual
      \node[label,green!50!black] at (3.7,-0.3) {no C49+B residual};
    \end{scope}
  \end{tikzpicture}}
