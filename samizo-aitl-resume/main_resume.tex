...
% --- GitHub Actions (Ubuntu + TeX Live) で確実に通る最小・安定構成 ---
\usepackage{fontspec}            % 先に fontspec
\usepackage{luatexja}
\usepackage{luatexja-fontspec}

% 日本語/欧文フォント（TeX Live 標準）
...
\usepackage{array}
\usepackage{xcolor}
\usepackage{siunitx}             % μm 等は \SI{0.25}{\micro\metre} で安全
...
% （必要なら）μm の短縮表記
\newcommand{\um}{\SI{}{\micro\metre}} % 例: 0.25\,\um → \SI{0.25}{\micro\metre} 推奨
