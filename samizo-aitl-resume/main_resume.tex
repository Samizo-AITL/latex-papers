...
\cvsection{職務要約}
半導体プロセス・デバイス（CMOSロジック/メモリ/高耐圧インテグレーション）、インクジェットMEMS（薄膜ピエゾ）、プリントヘッド電装部品、BOM運用、品質保証の一連業務で27年以上の実績。量産トラブルの根因解析から工程最適化・歩留まり改善を主導。近年はBOM電子化、BCP二拠点生産、コスト合理化（Auめっき厚最適化で年約10億円削減）を推進。2024年以降は独立し、教育教材（Edusemi, EduController, AITL-H）をGitHubで公開。
