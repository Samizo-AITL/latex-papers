...
% --- 日本語/欧文フォントを Actions で確実に通る設定に変更 ---
\usepackage{luatexja}
\usepackage{luatexja-fontspec}
\usepackage{fontspec}
\setmainjfont{HaranoAji Mincho}   % TeX Live 同梱（Ubuntu Actionsで常備）
\setsansjfont{HaranoAji Gothic}   % 同上
\setmainfont{TeX Gyre Termes}     % 欧文
\setsansfont{TeX Gyre Heros}      % 欧文
