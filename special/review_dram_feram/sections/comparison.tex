...
% 代表点（概念値）
\addplot+[only marks, mark=*, mark size=1.6pt] coordinates {(5, 1e-2)};     \addlegendentry{DRAM (typ.)}
\addplot+[only marks, mark=square*, mark size=1.8pt] coordinates {(30, 1e5)}; \addlegendentry{FeRAM (typ.)}

% おおまかな領域（薄グレーの四角）
\addplot [draw=black, fill=black!10, opacity=0.3] coordinates {(2,1e-3) (15,1e-3) (15,5e-2) (2,5e-2)};
\addplot [draw=black, fill=black!10, opacity=0.2] coordinates {(10,1e3) (80,1e3) (80,1e7) (10,1e7)};
...
\addplot+[only marks, mark=*, mark size=1.6pt]    coordinates {(5, 30)};     \addlegendentry{DRAM (typ.)}
\addplot+[only marks, mark=square*, mark size=1.8pt] coordinates {(50, 1000)};  \addlegendentry{FeRAM (typ.)}

% 領域矩形
\addplot [draw=black, fill=black!10, opacity=0.3] coordinates {(2,10) (15,10) (15,200) (2,200)};
\addplot [draw=black, fill=black!10, opacity=0.2] coordinates {(20,400) (150,400) (150,1e4) (20,1e4)};
