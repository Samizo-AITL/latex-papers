...
\begin{figure}[!t]
  ...
  \begin{tikzpicture}[font=\footnotesize, >=Stealth]
    ...
    \tikzset{
      ...
      arrow/.style={->, thick},
      note/.style={align=left, draw=black, fill=black!3,
                   rounded corners, inner sep=3pt, text width=7.2cm}
    }
    ...
    % SystemDK note（図の下部に収めて本文と衝突しない配置）
    \node[note] (sdk) at (0,\ynote)
      {\textbf{SystemDK} top-down co-design: holistic optimization across chiplets, controllers, and OS.};
    \draw[arrow] (sdk.north) -- (fram.south);
  \end{tikzpicture}
