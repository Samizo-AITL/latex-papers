...
\begin{tikzpicture}
\begin{loglogaxis}[
  width=\columnwidth, height=0.28\textheight,  % ★片段幅・背を確保して視認性アップ
  ...
  legend style={draw=none, fill=white, at={(0.98,0.07)}, anchor=south east, font=\scriptsize}, % ★右下内側
